...
SECRET_KEY = 'django-insecure-q)+^5iq^a*$ri+w5d869)&s!i(ddkyh_5(l-_f-gqrafm1r1pr'
...
'default': {
        ...
        'HOST': 'DESKTOP-1VKUE0I\SQLEXPRESS',  # Replace with your database server (e.g., localhost or IP address)
